...
// Torus
const moonTexture1 = new THREE.TextureLoader().load('mela.jpg');
const geometry = new THREE.TorusGeometry(1, 10,100, 100);
const material = new THREE.MeshStandardMaterial({  map: moonTexture1 });
